...
export default function Contact() {
  ...
  return (
    ...
    <Head>
      <title>
        Contact Us |Explore Temples, Culture & Heritage| Holiday Vibes
      </title>
      <meta
      name="description"
      content="Get in touch with local tour providers in Ayodhya, Varanasi, Lucknow, Delhi, Jaipur for tour bookings"
      />
      <meta
      name="keywords"
      content="Contact Ayodhya tour, ayodhya tour packages, ayodhya tour itinerary, ram mandir timing, tour travel packages in ayodhya"
      />
    </Head>
      <div className="py-16">
        <main className="">
